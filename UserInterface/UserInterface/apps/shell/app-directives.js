app.
    ...
    directive("settingsPane", function () {
        return {
            restrict: "E",
            templateUrl: appHelper.shellTemplatePath("layout/settings-pane"),
    ...
    directive("horizontalMenu", function () {
        return {
            restrict: "E",
            replace: true,
            templateUrl: appHelper.shellTemplatePath("layout/horizontal-menu"),
    ...
    directive("sidebarMenu", function () {
        return {
            restrict: "E",
            templateUrl: appHelper.shellTemplatePath("layout/sidebar-menu"),
    ...
    directive("sidebarChat", function () {
        return {
            restrict: "E",
            replace: true,
            templateUrl: appHelper.shellTemplatePath("layout/sidebar-chat")
        };
    }).
    directive("footerChat", function () {
        return {
            ...
            templateUrl: appHelper.shellTemplatePath("layout/footer-chat")
        };
    }).
    directive("sidebarLogo", function () {
        return {
            restrict: "E",
            replace: true,
            templateUrl: appHelper.shellTemplatePath("layout/sidebar-logo")
        };
    }).
    directive("sidebarProfile", function () {
        return {
            restrict: "E",
            replace: true,
            templateUrl: appHelper.shellTemplatePath("layout/sidebar-profile")
        };
    }).
    directive("userInfoNavbar", function (currentUser) {
        return {
            restrict: "E",
            replace: true,
            templateUrl: appHelper.shellTemplatePath("layout/user-info-navbar"),
    ...
    directive("pageTitle", function () {
        return {
            ...
            templateUrl: appHelper.shellTemplatePath("layout/page-title")
    ...
    directive("siteFooter", function () {
        return {
            restrict: "E",
            templateUrl: appHelper.shellTemplatePath("layout/footer")
        };
    }).
    ...
    directive('duplicateCode', ['$http', function ($http) {
        return {
            restrict: 'A',
            require: 'ngModel',
            link: function (scope, element, attrs, ctrl) {
                ...
                element.on('blur', function () {
                    if (ctrl.$viewValue != scope.initialValue) {
                        var dataUrl = attrs.url + "/" + ctrl.$viewValue;
                        $http.get(dataUrl).success(function (data) {
                            ctrl.$setValidity('isduplicate', !data);
